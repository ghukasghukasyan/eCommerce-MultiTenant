        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    DefaultCommissionRate = table.Column<int>(type: "integer", nullable: false),
                    AvatarUrl = table.Column<string>(type: "text", nullable: true),
                    InstagramAccountUrl = table.Column<string>(type: "text", nullable: true),
                    TikTokAccountUrl = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingDetail_FullName = table.Column<string>(type: "text", nullable: true),
                    ShippingDetail_PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    ShippingDetail_City = table.Column<string>(type: "text", nullable: true),
                    ShippingDetail_Address = table.Column<string>(type: "text", nullable: true),
                    ShippingDetail_Notes = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "380fd12a-a2c7-402d-a806-9c964adc6e0e", "1", "Admin", "ADMIN" },
                    { "bagb8de8-6d52-4bb8-b9d9-889c0e49071b", "2", "Influencer", "INFLUENCER" },
                    { "eccb8de8-6d52-4bb8-b9d9-889c0e49071b", "2", "User", "USER" }
                });
